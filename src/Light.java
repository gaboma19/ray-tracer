...
public class Light  
{
  ...
  public String getType(){
	  ...
	  else if(this.type == LightType.INFINITE){
		  return "infinite";
	  }
	  else{
		  return "ambient";
  ...
  public Coord getPos(){
	  return new Coord(pos[0], pos[1], pos[2]);	  
  }
  
  public Coord getDir(){
	  return new Coord(dir[0], dir[1], dir[2]);
  }
  
  public int[] getColor(){
	  int[] color= new int[3];
	  color[0] = (int)(rgb[0] * 255);
	  color[1] = (int)(rgb[1] * 255);
	  color[2] = (int)(rgb[2] * 255);
	  return color;
  }
